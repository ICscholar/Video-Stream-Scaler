...
module edb_top (
    ...
    output bscan_TDO,
    input  la0_clk,
    input  [10:0] la0_probe0,
    input  [10:0] la0_probe1,
    input  [10:0] la0_probe2,
    input  [10:0] la0_probe3,
    input  [10:0] la0_probe4,
    input  [10:0] la0_probe5,
    input  la0_probe6
);
    ...
    edb_la_top #(
        ...
        .INPUT_PIPE_STAGES      ( 1 ),
        .CAPTURE_CONTROL    ( 0 ),
        .UUID   ( 128'hf81588f843fb4569970951bc2637c033 ),
        .CNDTNL_STRG_EN     ( 0 ),
        .PROBE0_WIDTH       ( 11 ),
        .PROBE0_TYPE        ( 2 ),
        .PROBE1_WIDTH       ( 11 ),
