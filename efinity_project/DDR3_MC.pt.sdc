...
# PLL Constraints
#################
create_clock -period 10.0 sys_clk
...
create_clock -waveform {0.3367 1.0101} -period 1.3468 hdmi_rx_fast_clk
...
#create_clock -waveform {0.8418 1.5152} -period 1.3468 hdmi_rx_fast_clk
#create_clock -waveform {0.6734 1.3468} -period 1.3468 hdmi_tx_fast_clk
#create_clock -waveform {3.3670 6.7340} -period 6.7340 hdmi_rx_slow_clk
...
create_clock -period 8.000 [get_ports {rxc}]
create_clock -period 8.00 [get_ports {rxc1}]
